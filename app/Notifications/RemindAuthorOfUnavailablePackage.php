...
class RemindAuthorOfUnavailablePackage extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('If we cannot verify the package URL within two weeks, we will remove the package from the directory. Thank you for helping us keep NovaPackages up to date!');
    }
}
