...
<body class="bg-page-background font-sans font-normal">
    <div class="flex flex-col sm:flex-row bg-indigo-darker px-8 py-4 items-center justify-between">
        <a href="/" class="flex items-center text-white font-bold text-md no-underline uppercase">
            ...
            <span class="text-indigo-lighter">Packages</span>
        </a>
        <div class="mt-8 sm:mt-0">
            ...
            <a href="{{ route('login') }}" class="no-underline hover:underline text-sm font-bold text-white px-3 flex flex-row items-center">
                <svg class="w-6 h-6 mr-2 text-indigo-lighter" viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                    <g>
