...
<div class="w-full">
    ...
    <div class="md:flex mb-12">
        ...
        <div x-data="{ 'pageSize': {{ $pageSize }}, 'open': false }" class="inline-block md:flex-initial ml-4 md:ml-0 mt-4 md:mt-0 relative text-gray-700">
            ...
            <div class="hover:bg-white inline-block border border-gray-400 cursor-pointer p-2 rounded-sm" @click="open = true" :class="{ 'bg-white': open}">
            ...
            <div x-show="open" @click.away="open = false" class="absolute bg-white border border-gray-400 mt-9 top-0 w-full" x-cloak>
