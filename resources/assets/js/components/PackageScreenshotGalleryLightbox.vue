<template>
    <div class="w-full h-full fixed pin-t pin-l text-center" style="background: rgba(0,0,0,0.9);" @click.self="closeLightbox">
        <div class="relative mx-auto m-h-screen max-w-xl flex items-center justify-center">
            ...
            <div>
                 <a class="text-white cursor-pointer absolute pin-t pt-4 pl-4" @click="closeLightbox">
